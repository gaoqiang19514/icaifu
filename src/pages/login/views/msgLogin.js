...
const StyleGetCode = button.extend`
    color: #fff;
    flex-shrink: 0;
                    ...
                    <div>
                        ...
                        <div>
                            <LayoutRow>
                                ...
                                <StyleInput type="text" value={ this.state.pswd } onChange={ this.onPasswordChangeHandle } innerRef={ input => this.passwordInput = input } placeholder="请输入验证码" />
                                <StyleClearIconPswd innerRef={ input => this.passwordBtn = input } onClick={ this.onPasswordClearHandle }/>
                                <StyleGetCode>获取短信验证码</StyleGetCode>
                            </LayoutRow>
                        </div>
                    </div>
                    <LayoutPrimaryBox>
